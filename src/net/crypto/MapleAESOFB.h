...
class MapleAESOFB
{
    public:
        ...
        byte[] getPacketHeader(int length);
        ...
        std::string toString();
        byte[] funnyShit(byte inputByte, byte[] in);
    ...
    private:
        ...
        //Cipher cipher;
        _short mapleVersion;
        byte[] funnyBytes = new byte[]{(byte) 0xEC, (byte) 0x3F, (byte) 0x77, (byte) 0xA4, (byte) 0x45, (byte) 0xD0, (byte) 0x71, (byte) 0xBF, (byte) 0xB7, (byte) 0x98, (byte) 0x20, (byte) 0xFC,
